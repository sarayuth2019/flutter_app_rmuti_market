...
void showAlertSelectType1(BuildContext context,token,marketId) async {
  return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('ประเภทของสินค้า',style: TextStyle(fontWeight: FontWeight.bold),),
              ...
              children: [
                Container(
                    child: GestureDetector(
                        ...
                        onTap: () {
                          var typeItemSell = 1;
                         Navigator.push(context, MaterialPageRoute(builder: (context)=>SellProducts(token, marketId,typeItemSell)));
                        })),
                SizedBox(
                  height: 10,
                ),
