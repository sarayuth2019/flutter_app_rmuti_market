                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                       ...
                                       */
                                      SizedBox(height: 10),
                                      snapshotPaymentAdmin.data.status ==
                                              "รอดำเนินการ"
                                          ? Center(
                                              child: ElevatedButton(
                                                  style:
     ...
     */
      ...
      setState(() {
        saveStatusPaymentAdmin(
            ...
            paymentAdminData,
            adminId,
            'ชำระเงินของ ItemId:${itemData.itemId},จำนวนคนทะเบียน : ${itemData.count}/${itemData.countRequest},รวมเป็นเงิน:${amount.toString()}',
            _bankTransferValue,
            _bankReceiveValue,
            _dateTransfer,
            _timeTransfer,
